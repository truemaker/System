...
i386-elf-gcc -ffreestanding -m32 -g -c "kernel.cpp" -o "Binaries/kernel.o" -Wwrite-strings -Wall -Wdiv-by-zero -Wunused-variable
nasm "zeroes.asm" -f bin -o "Binaries/zeroes.bin"

i386-elf-ld -m elf_i386 -o "Binaries/full_kernel.bin" -Ttext 0x1000 "Binaries/kernel_entry.o" "Binaries/kernel.o" --oformat binary
